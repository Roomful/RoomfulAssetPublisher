...
namespace RF.AssetWizzard
{
    ...
    public class AssetBundlesSettings : ScriptableObject
    {
        ...
        public const string PROJECT_ASSETS_FOLDER = "Assets/Roomful/";
        ...
        public const string FULL_AUTOMATIC_REUPLOADER_TEMP_LOCATION =
            "Assets/Roomful/AutoReUploaderTemp/AutomaticLoaderInProgress/";
        ...
        public const string PACKAGE_LOCATION = "Packages/" +PACKAGE_NAME + "/";
        ...
        [SerializeField] public List<PropTemplate> LocalPropTemplates = new List<PropTemplate>();
        [SerializeField] public List<StyleTemplate> LocalStyleTemplates = new List<StyleTemplate>();
        [SerializeField] public List<EnvironmentTemplate> LocalEnvironmentsTemplates = new List<EnvironmentTemplate>();
