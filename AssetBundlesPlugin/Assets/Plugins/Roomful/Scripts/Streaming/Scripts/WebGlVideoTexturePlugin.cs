...
public class WebGlVideoTexturePlugin : MonoBehaviour, IVideoTexturePlugin
{
    ...
    public bool IsPresenterTextureReady
    {
        ...
        {
#if UNITY_WEBGL
            return m_VideoTextureCurrentPresenter != null && m_VideoTextureCurrentPresenter.isReadable && IsWebGlVideoChatTextureReady(k_PresenterIdentity);
#else
            return false;
#endif
        }
    ...
    public bool IsShareScreenTextureReady{
        ...
        {
#if UNITY_WEBGL
            return m_VideoTextureCurrentShareScreen != null && m_VideoTextureCurrentShareScreen.isReadable && IsWebGlVideoChatTextureReady(k_ShareScreenIdentity);
#else
            return false;
#endif
        }
    ...
    public void Init()
    {
        ...
        // Presenter
        m_VideoTextureCurrentPresenter = new Texture2D(1, 1, TextureFormat.RGBA32, false) { wrapMode = TextureWrapMode.Clamp };
        m_VideoTextureCurrentPresenter.SetPixel(0, 0, Color.black);
        m_VideoTextureCurrentPresenter.Apply();

        // Share screen
        m_VideoTextureCurrentShareScreen = new Texture2D(1, 1, TextureFormat.RGBA32, false) { wrapMode = TextureWrapMode.Clamp };
    ...
    public void Update()
    {
        ...
        if (IsPresenterTextureReady)
        {
            ...
            WebGlVideoChatVideoTextureUpdate(k_PresenterIdentity, m_VideoTextureCurrentPresenter.GetNativeTexturePtr().ToInt32());
        }
        ...
        if (IsShareScreenTextureReady)
        {
            ...
            if (width != m_VideoTextureCurrentShareScreen.width || height != m_VideoTextureCurrentShareScreen.height)
            {
                m_VideoTextureCurrentShareScreen.Resize(width, height, TextureFormat.RGBA32, false);
                m_VideoTextureCurrentShareScreen.Apply();
            }

            WebGlVideoChatVideoTextureUpdate(k_ShareScreenIdentity, m_VideoTextureCurrentShareScreen.GetNativeTexturePtr().ToInt32());
        }
#endif
    }
}
