...
namespace SA.UltimateLogger.Platforms {
	...
	public class iOS_Bridge : ILogBridge {



		public const string DISABLED_MESSAGE = "Record logs output on iOS is disabled by user. If you need this feature enable it under Stan's Assets -> Ultimate Logger -> Settins (Platfroms tab)";
		...
		public void ShowSharingUI() {
			...
			if(!LoggerPlatfromsSettings.Instance.iOS_LogsRecord) {
				Debug.LogWarning (DISABLED_MESSAGE);
			}
