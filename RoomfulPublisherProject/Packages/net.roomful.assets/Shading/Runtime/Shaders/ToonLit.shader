Shader "Roomful/Toon Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/net.roomful.assets/Shading/Runtime/ShaderLibrary/ToonLitInput.hlsl"
            #include "Packages/net.roomful.assets/Shading/Runtime/ShaderLibrary/ToonLighting.hlsl"
            #include "Packages/net.roomful.assets/Shading/Runtime/ShaderLibrary/Lighting.hlsl"
            #include "Packages/net.roomful.assets/Shading/Runtime/ShaderLibrary/LitForwardPass.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "net.roomful.shaders.editor.ToonLitGUI"
