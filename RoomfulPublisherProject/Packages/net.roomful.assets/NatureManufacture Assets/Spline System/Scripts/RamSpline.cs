...
public class RamSpline : MonoBehaviour
{
    ...
    public static RamSpline CreateSpline(Material splineMaterial = null, List<Vector4> positions = null, string name = "RamSpline") {
        return CreateSpline<RamSpline>(splineMaterial, positions, name);
    }

    public static RamSpline CreateSpline<T>(Material splineMaterial = null, List<Vector4> positions = null, string name = "RamSpline") where T : RamSpline {
        GameObject gameobject = new GameObject(name);
        gameobject.layer = LayerMask.NameToLayer("Water");
        RamSpline spline = gameobject.AddComponent<T>();
