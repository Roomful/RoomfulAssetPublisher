...
namespace net.roomful.assets.serialization
{
    ...
    public class SerializedTexture
    {
        ...
        public string[] Platforms = new[] { "iPhone", "Android", "WebGL", "StandaloneWindows64", "StandaloneOSX" };
        ...
        public void Serialize(Texture tex) {
            ...
            // Not using Platform overrides at this point...

            // var ps = new List<SerializedPlatformTextureSettings>();

            // for (var i = 0; i < Platforms.Length; i++) {
            //     var platformString = Platforms[i];
            ...
            //         var spts = new SerializedPlatformTextureSettings();
