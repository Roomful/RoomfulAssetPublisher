...
namespace net.roomful.assets.editor
{
    internal static class BundleUtility
    {
        ...
        public static void SaveTemplateToFile(string path, ISerializableTemplate tpl) {
        ...
        public static void GenerateUploadPrefab(IAsset asset) {
            var prefabName = $"{asset.GetTemplate().Title}_{asset.GetTemplate().Id}";
        ...
        public static void ClearLocalCacheForAsset(string assetTitle) {
            var path = AssetBundlesSettings.ASSETS_RESOURCES_LOCATION + "/" + assetTitle;
