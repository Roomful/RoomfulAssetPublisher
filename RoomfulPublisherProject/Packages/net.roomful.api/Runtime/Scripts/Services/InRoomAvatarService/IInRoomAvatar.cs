...
{
    public static class AvatarNavigationPriority
    {
        public static readonly int LOW_AVOIDANCE_PRIORITY = 60;
        public static readonly int MEDIUM_AVOIDANCE_PRIORITY = 30;
        public static readonly int HIGH_AVOIDANCE_PRIORITY = 0;
    } 
    ...
    public interface IInRoomAvatar
    {
        ...
        void SetDestination(Vector3 destination, Action<AvatarMovingResult> callback = null, bool teleportIfCanNotReached = false, float maxArrivalTime = -1f);
        ...
        /// <param name="callback">Callback when moving complete. Flag tells whether the destination has been reached</param>
        ///</summary>
        void SetDestination(IAvatarPositionMarker marker, Action<AvatarMovingResult> callback = null, float maxArrivalTime = -1f);
