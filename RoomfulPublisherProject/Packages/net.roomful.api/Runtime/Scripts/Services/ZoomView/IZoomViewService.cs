...
namespace net.roomful.api.zoom
{
    public interface IZoomViewService
    {
        ...
        bool HasCustomPropLinksProvider { get; }
        IZoomViewPropLinksProvider CustomPropLinksProvider { get; }
        ...
        /// <summary>
        /// Opens prop manage content dialog.
        /// </summary>
        /// <param name="prop">Target Prop</param>
        void OpenManageContentDialog(IProp prop);
