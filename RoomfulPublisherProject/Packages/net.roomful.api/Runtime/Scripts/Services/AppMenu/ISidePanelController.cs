...
namespace net.roomful.api.appMenu
{
    ...
    /// </summary>
    public interface ISidePanelController : IPanelView, IColorizationSubject, IUISynchronizedSubject
    {
        /// <summary>
        ...
        event Action<float, float, float> OnMenuChanged;
        public event Action<string> OnSideMenuActivated;
        ...
        IButtonView AddTabButton(ButtonData buttonData, params ButtonOption[] options);
        ...
        ISideMenuDelegate ShowSideMenu(IButtonView button, RectTransform customMenuRoot, bool deleteWhenClose = false);
        ...
        /// <summary>
        /// Show  tabbed side menu for the button.
        /// </summary>
        /// <param name="button">Target button.</param>
        ...
        /// <summary>
        /// Returns unused height from bottom to buttons.
        /// </summary>
        float FreeHeight();
