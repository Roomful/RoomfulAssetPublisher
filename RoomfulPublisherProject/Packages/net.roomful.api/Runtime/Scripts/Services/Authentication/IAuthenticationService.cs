...
namespace net.roomful.api.authentication
{
    ...
    public interface IAuthenticationService
    {
        ...
        /// <summary>
        /// Event is fired before Log out process will start.
        /// Normally you can finalize your service logout using OnLogout actions.
        /// But if for some reason you need an active session for finalization logout action in your service
        /// You can the use on logout event.
        /// </summary>
        event Action OnAboutToLogOut;
        ...
        /// <summary>
        /// The domain associated with the current user authentication.
        /// </summary>
        IAuthenticationDomain Domain { get; }
