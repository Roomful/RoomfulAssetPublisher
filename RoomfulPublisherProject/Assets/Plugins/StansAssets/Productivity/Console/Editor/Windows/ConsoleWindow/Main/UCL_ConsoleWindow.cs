...
namespace SA.Productivity.Console
{
    ...
    public class UCL_ConsoleWindow : EditorWindow, IHasCustomMenu
    {
		...
		private const string SEARTCH_BAR_CONTROL_NAME = "ucl_seartchBat";

        private SA_SplitView m_rootView;
        private Rect m_rootViewRect = new Rect(Vector2.zero, Vector2.zero);


        private GUIStyle m_toolbarStyle = null;
        private GUIStyle m_toolbarSeachTextFieldStyle = null;
        private GUIStyle m_toolbarSeachCancelButtonStyle = null;

        private string m_searchString = string.Empty;
        private int m_lastLogsCount = 0;
        ...
        private void InitStyles() {
            ...
            m_toolbarSeachTextFieldStyle = GUI.skin.FindStyle("ToolbarSeachTextField");
            m_toolbarSeachCancelButtonStyle = GUI.skin.FindStyle("ToolbarSeachCancelButton");
        }
        ...
        private void SetupUI() {
            ...
            if (!EditorGUIUtility.isProSkin) {
                GUI.DrawTexture(new Rect(0, 0, position.width, position.height), Texture2DUtility.MakePlainColorImage("#DFDFDFFF"));
            }
        }
        ...
        private void HandleInputEvents() {
            ...
            if (GUI.GetNameOfFocusedControl().Equals(SEARTCH_BAR_CONTROL_NAME)) {
                EditorGUI.FocusTextInControl(SEARTCH_BAR_CONTROL_NAME);
                ...
                if (Event.current.type == EventType.KeyDown) {
                    ...
                    switch (Event.current.keyCode) {
                        ...
                        default:
                            EditorGUI.FocusTextInControl(SEARTCH_BAR_CONTROL_NAME);
                            //GUI.FocusControl(SEARTCH_BAR_CONTROL_NAME);
                            break;
                    }
                }
            }
        ...
        private void DrawToolbar() {
            ...
            GUILayout.BeginHorizontal(EditorStyles.toolbar);
            {
                ...
                if (m_state.DisplaySeartchBar) {
                    GUILayout.BeginHorizontal(m_toolbarStyle);
                    {
                        GUI.SetNextControlName(SEARTCH_BAR_CONTROL_NAME);
                        m_searchString = EditorGUILayout.TextField(m_searchString, m_toolbarSeachTextFieldStyle, GUILayout.MinWidth(200f));

                        if (GUILayout.Button("", m_toolbarSeachCancelButtonStyle)) {
                            m_searchString = "";
                            GUI.FocusControl(null);
                        }
