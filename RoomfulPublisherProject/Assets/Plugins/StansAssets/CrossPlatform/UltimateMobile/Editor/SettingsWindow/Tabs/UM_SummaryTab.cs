...
namespace SA.CrossPlatform.Editor
{
    ...
    {
        IMGUICollapsableWindowBlockLayout m_IOSRequirements;
        IMGUICollapsableWindowBlockLayout m_AndroidRequirements;
        IMGUICollapsableWindowBlockLayout m_UnityRequirements;
        ...
        public override void OnLayoutEnable()
        {
            ...
            m_IOSRequirements = new IMGUICollapsableWindowBlockLayout(content, XCodeRequirements);

            content = new GUIContent("Android Build Requirements", UM_Skin.GetPlatformIcon("android_icon.png"));
            m_AndroidRequirements = new IMGUICollapsableWindowBlockLayout(content, AndroidRequirements);

            content = new GUIContent("Unity Project Requirements ", UM_Skin.GetPlatformIcon("unity_icon.png"));
            m_UnityRequirements = new IMGUICollapsableWindowBlockLayout(content, DefineSymbols);
        ...
        void DefineSymbols()
        {
            ...
            {
                var defines = EditorDefines.GetScriptingDefines();
                if (defines.Length > 0)
