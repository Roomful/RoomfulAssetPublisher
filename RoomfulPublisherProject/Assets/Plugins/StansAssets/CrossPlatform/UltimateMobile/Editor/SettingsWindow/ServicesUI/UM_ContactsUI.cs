    ...
    class UM_ContactsUI : UM_ServiceSettingsUI
    {
        ...
        protected override void OnServiceUI()
        {
            using (new SA_WindowBlockWithSpace(new GUIContent("Editor Testing")))
            {
                ...
                IMGUILayout.ReorderablList(UM_Settings.Instance.EditorTestingContacts, GetContactDisplayName, DrawProductContent, () =>
                {
                    const string johnSmith = "John Smith";
                    const string phone = "1–800–854–3680";
                    const string email = "johnsmith@gmail.com";

                    var contact = new UM_EditorContact(johnSmith, phone, email);
